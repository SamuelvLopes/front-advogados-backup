            ...
            <CardHeader className="p-6">
              <div className="flex items-center space-x-3 mb-2">
                <Briefcase className="h-7 w-7 text-accent" />
                 <CardTitle className="text-xl md:text-2xl font-headline text-primary">Casos para Atuação</CardTitle>
              </div>
              <CardDescription className="text-muted-foreground">Veja os casos submetidos e ofereça sua ajuda voluntária.</CardDescription>
            </CardHeader>
            <CardContent className="p-6 pt-0">
              <p className="text-muted-foreground mb-6 text-sm">
              ...
              <Button asChild size="lg" className="w-full bg-accent hover:bg-accent/85 text-accent-foreground transform hover:scale-102 transition-transform duration-150 group">
                <Link href="/cases">Ver Casos Disponíveis <ExternalLink className="ml-2 h-4 w-4 opacity-70 group-hover:opacity-100"/></Link>
              </Button>
            </CardContent>
          </Card>
        )}
